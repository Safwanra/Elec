...
class Snake:
    def __init__(self):
        ...
        self.facing = "right"
        self.initialize()
#Initialising the function -> used to set the snake's positon and the game score when starting the game.
    def initialize(self):
        self.position = [6, 6]
...
#Blit_head function -> used to set the snake's tail and how it is moved during the play game.          
...
#Blit function -> used to set the snake's move range in the screen.
...
#Update function -> used to set that when the snake moves the position will change.     
    def update(self):
...
#Initialising the class Settings -> used to Randomly generate strawberries on the screen.  
class Strawberry():
    ...
    def initialize(self):
        self.position = [15, 10]
#Initialising the class Settings -> used to assign values for setting ,snake strawberry and move_dict.
class Game:
    """
    """
    def __init__(self):
        ...
        self.move_dict = {0 : 'up',
                          ...
                          2 : 'left',
                          3 : 'right'}       
#When the game restart, assign values for snake and strawberry again.      
...
#Do_move function -> used to set that when user hits the direction key on the keyboard, the snake will move in the specified direction.
    def do_move(self, move):
        ...
        self.snake.update()
#Used to set how the score is added.
        ...
        return reward
#Game_end function -> used to set that when the sanke touches the edge of screen,the game ends.
    def game_end(self):
        end = False
        ...
        return end
#Blit_score function -> used to set  when the game is over the score will display on the screen.
